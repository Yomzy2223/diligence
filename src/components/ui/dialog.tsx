...
interface ExtraDialogContentProps {
  showClose?: boolean;
  cancel?: () => void;
}
...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & ExtraDialogContentProps
>(({ className, children, showClose = true, cancel, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay onClick={cancel} />
