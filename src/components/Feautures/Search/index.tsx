  ...
  return (
    <div className="w-full h-14 rounded-lg border border-[#EDF1F6] flex justify-between items-center px-4 py-4">
      <input
        ...
        className="w-[90%]  text-sm not-italic font-normal leading-5 text-gray-700 border border-none outline outline-none bg-transparent placeholder-shown:text-gray-700"
      />
