                    ...
                    >
                        ...
                        <div className="flex items-center justify-between">
                            <div className="space-y-1">
                                ...
                                <p className="text-xs text-muted-foregroun py-2">
                        ...
                        <div className="buttons flex m-5 space-x-4">
                            <div>
                                <Button variant={"outline"} className="justify-center items-center text-[#DE4A09] gap-2 rounded-8 border-2 border-[#DE4A09] bg-transparent">Decline</Button>
                            </div>
                            <div>
