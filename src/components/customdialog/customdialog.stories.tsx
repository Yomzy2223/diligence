...
const DialogWithTrigger = ({ children, ...args }: IdialogProps) => {
  ...
  return (
    <>
      <Button onClick={toggleDialog}>Trigger Dialog With State</Button>
      <Dialog {...args} dialogType="state" open={openDialog} cancel={toggleDialog}>
        {children}
      </Dialog>
    </>
  );
